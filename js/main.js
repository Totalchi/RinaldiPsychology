...
const T = {
  en: {
    ...
    'about.phil.label':     'My philosophy',
    'about.phil.title':     'How I approach therapy',
    'about.phil.body':      'I believe therapy works best when it feels like a genuine collaboration — not an expert telling you what to do, but two people working together toward what matters to you. My role is to offer structure, tools, and a safe space. Your role is to bring your honesty and courage. Together, we figure out the rest.',
    'about.tools.label':    'My tools',
    'about.tools.title':    'Evidence-based methods',
    'about.tools.sub':      'I draw on two of the most well-researched approaches in modern psychology, adapting them to your specific needs and goals.',
    'about.process.label':  'The journey',
    'about.process.title':  'How we work together',
    'about.process.sub':    'Every therapeutic path is unique. Here is what working with me typically looks like.',
  ...
  it: {
    ...
    'about.phil.label':     'La mia filosofia',
    'about.phil.title':     'Come mi avvicino alla terapia',
    'about.phil.body':      'Credo che la terapia funzioni meglio quando diventa una vera collaborazione — non un esperto che ti dice cosa fare, ma due persone che lavorano insieme verso ciò che conta per te. Il mio ruolo è offrire struttura, strumenti e uno spazio sicuro. Il tuo è portare la tua onestà e il tuo coraggio. Insieme troviamo il resto.',
    'about.tools.label':    'I miei strumenti',
    'about.tools.title':    'Metodi basati su prove',
    'about.tools.sub':      'Mi avvalgo di due degli approcci più studiati nella psicologia moderna, adattandoli alle tue esigenze e ai tuoi obiettivi specifici.',
    'about.process.label':  'Il percorso',
    'about.process.title':  'Come lavoriamo insieme',
    'about.process.sub':    'Ogni percorso terapeutico è unico. Ecco come si svolge tipicamente il lavoro con me.',
    ...
    'appt.d.phone':         'WhatsApp / Telefono',
    'appt.d6.label':        'Email',
